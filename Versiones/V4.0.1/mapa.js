...
document.getElementById('quizForm').addEventListener('submit', function(event) {
  ...
  // Mostrar el puntaje total combinado al usuario
...
function resetApp() {
  ...
  // Borrar la ruta y el marcador de la ruta
  directionsDisplay.setMap(null);
  routeMarker.setMap(null);

  // Reiniciar las variables y conjuntos
  ...
  // Reiniciar la información del resultado y del formulario
  document.getElementById('result').innerText = '';
  document.getElementById('quizForm').reset();

  // Reiniciar la funcionalidad de trazar rutas
  directionsDisplay.setMap(null);
  directionsDisplay.setMap(map);
  clearInterval(updateInterval);

  // Reiniciar el mapa
  map.setCenter({lat: 25.5397, lng: -103.4460}); // Centrar el mapa en las coordenadas originales
  map.setZoom(12); // Restablecer el zoom

  // Realizar los cálculos después de reiniciar
  calculateScores();

  // Actualizar la interfaz para indicar que la ruta se ha borrado
  alert("Ingresa nuevos datos.");
}
